@extends('layout.master', ['title' => 'Edit KIP - Personal Site'])
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="kip_judul_tema" id="kip_judul_tema" value="{{ $kip->kip_judul_tema }}">
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="disabled_nama" id="disabled_nama" value="{{ $kip->user_name }}" disabled>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="disabled_npk" id="disabled_npk" value="{{ $kip->user_npk }}" disabled>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="kip_proses" id="kip_proses" value="{{ $kip->kip_proses }}">
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="form-group">
          ...
          <textarea class="form-control jodit" name="kip_masalah" id="kip_masalah">{{ htmlspecialchars_decode($kip->kip_masalah) }}</textarea>
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="form-group">
          ...
          <textarea class="form-control jodit" name="kip_perbaikan" id="kip_perbaikan">{{ htmlspecialchars_decode($kip->kip_perbaikan) }}</textarea>
        </div>
      </div>
